      ...
      <div className="relative w-full max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-3xl text-center relative z-10">
          ...
          <h1 className="text-[64px] leading-[1.1] font-bold tracking-tight text-[#1E293B]">
            Transforming Audit &<br />
            Advisory with <span className="text-blue-600">AI Intelligence</span>
          </h1>
          <p className="mt-8 text-xl leading-8 text-gray-600 max-w-2xl mx-auto">
            SignalsHQ improves the performance of Audit & Advisory firms with
            agents to collect, extract, analyse, verify and reference
